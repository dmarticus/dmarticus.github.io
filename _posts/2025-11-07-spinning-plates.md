...
The really cursed bit has been where I've redirected my effort in the name plate-spinning optimization.
...
- structuring projects in ways that are maximally legible to an LLM (HackerNews was not too happy with my [first pass at adding .cursorrules to my main work repo](https://news.ycombinator.com/item?id=43305919)),
...
Some problems are still very much not "vibe-codeable": bizarre perf issues, gnarly data modeling, pathological failure modes where you really do have to build a mental model and play it forward in my head. Those are the problems that historically made me feel like a real engineer.
...
When I finally try to go deep, all I seem to have left are short bursts of focus, but it's been a long time since I've consistently been able to enter "flow state".
...
[^bignote]: Gergely Orosz writes about this and much more [in his post about this from July of this year](https://newsletter.pragmaticengineer.com/p/software-engineering-with-llms-in-2025).
