...
Working on open-source fulltime at 47 helped dispel basically all of these notions, and my biggest takeaway was that contributing to open-source was much less difficult than it appeared from the outside.  Mind, I still think there's still some opacity to the process(so much so that I felt inspired to [write a guide](https://www.dylanamartin.com/2020/10/15/my-experience-getting-started-in-open-source.html) about how to get involved), but I now feel like can be a much more confident and useful open-source contributor going forward.  
